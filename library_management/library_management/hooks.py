...
# def my_custom_meth(Doc):
#     if doc.doctype=="Library Transaction":
#             article_clear=frappe.get_doc("Article",self.article)
#             print("#"*40)
#             print(article_clear)
#             article_clear.status="Available"
#             frappe.throw("interrupt")

# doc_events = {
# 	"Library Transaction": {
	
# 		"on_trash": "my_custom_meth",
# 	}
# }
